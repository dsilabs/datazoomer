...
from zoom.database import Column, Columns
import MySQLdb
...
class TestDatabase(unittest.TestCase):
    ...
    def setUp(self):
        self.db = Database(MySQLdb.Connect,host='database',user='testuser',passwd='password',db='test') 
    ...
    def test_RecordSet(self):
        ...
        #TODO: Need Get and Set Slice test
